...
})({"cScS0":[function(require,module,exports,__globalThis) {
...
var _getSheetData = require("./getSheetData");
...
if (userId) (0, _qrcodeDefault.default).toCanvas(canvas, URL_VALIDACAO + userId, {
    width: 90
}, function(error) {
...
window.addEventListener("DOMContentLoaded", (event)=>{
    ...
    (0, _getSheetData.getSheetData)({
        // sheetID you can find in the URL of your spreadsheet after "spreadsheet/d/"
        sheetID: "1--SmowjrppeIYqzrCA5KIoQsIpFWO_QM",
        // sheetName is the name of the TAB in your spreadsheet (default is "Sheet1")
        sheetName: "usuarios",
        query: 'SELECT * WHERE A = "d8cfda83-8b4c-407d-93b9-9590f8798e61"',
        callback: sheetDataHandler
    });
});

},{"./getSheetData":"jsElS","qrcode":"4FYq0","@parcel/transformer-js/src/esmodule-helpers.js":"brd5t"}],"jsElS":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getSheetData", ()=>getSheetData);
const headers = {
    method: 'GET',
    headers: {
...
const getSheetData = ({ sheetID, sheetName, query, callback })=>{
    ...
    fetch(url, headers).then((res)=>res.text()).then((response)=>{
        // callback(response)
    ...
    function responseToObjects(res) {
        ...
        for(let r = 0, rowMax = rows.length; r < rowMax; r++){
            ...
            for(let c = 0, colMax = columns.length; c < colMax; c++){
                ...
                else if (typeof cellData["v"] == "string" && cellData["v"].startsWith("Date")) rowObject[propName] = cellData["f"];
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"brd5t"}],"brd5t":[function(require,module,exports,__globalThis) {
...
},{}],"4FYq0":[function(require,module,exports,__globalThis) {
const canPromise = require("995c7b51619b1db7");
const QRCode = require("47c4357e220c2126");
const CanvasRenderer = require("eb872925edc9ae28");
const SvgRenderer = require("f3d8b64ca5272643");
...
},{"995c7b51619b1db7":"4Be8b","47c4357e220c2126":"4gSH4","eb872925edc9ae28":"dFies","f3d8b64ca5272643":"909vL"}],"4Be8b":[function(require,module,exports,__globalThis) {
...
},{}],"4gSH4":[function(require,module,exports,__globalThis) {
const Utils = require("b51a31f9f0a35fca");
const ECLevel = require("637fc6754a3a8a57");
const BitBuffer = require("aca6df2c17cf8c69");
const BitMatrix = require("5a0a751cae5970c1");
const AlignmentPattern = require("920dbdf915cc6445");
const FinderPattern = require("a0ff4c083519c96a");
const MaskPattern = require("b7b7d42963e1fa8a");
const ECCode = require("dba03fd72133d925");
const ReedSolomonEncoder = require("1cfa43ba86c40de0");
const Version = require("40d88c6b4f230b8c");
const FormatInfo = require("47ca570df98b245e");
const Mode = require("d69e951781520678");
const Segments = require("ef42368d6e2f320b");
/**
...
},{"b51a31f9f0a35fca":"imGe5","637fc6754a3a8a57":"kOfkT","aca6df2c17cf8c69":"ixDGe","5a0a751cae5970c1":"koTtY","920dbdf915cc6445":"g22iF","a0ff4c083519c96a":"ebAZx","b7b7d42963e1fa8a":"fXKUB","dba03fd72133d925":"ZMwaT","1cfa43ba86c40de0":"5QhX5","40d88c6b4f230b8c":"9U3d4","47ca570df98b245e":"26gFF","d69e951781520678":"i92T9","ef42368d6e2f320b":"2lLSs"}],"imGe5":[function(require,module,exports,__globalThis) {
let toSJISFunction;
...
},{}],"kOfkT":[function(require,module,exports,__globalThis) {
exports.L = {
    bit: 1
};
exports.M = {
...
},{}],"ixDGe":[function(require,module,exports,__globalThis) {
function BitBuffer() {
    this.buffer = [];
    this.length = 0;
}
...
},{}],"koTtY":[function(require,module,exports,__globalThis) {
/**
...
},{}],"g22iF":[function(require,module,exports,__globalThis) {
/**
 ...
 */ const getSymbolSize = require("d5468de20be4cbe6").getSymbolSize;
/**
...
},{"d5468de20be4cbe6":"imGe5"}],"ebAZx":[function(require,module,exports,__globalThis) {
const getSymbolSize = require("d207c1db4ee74c2c").getSymbolSize;
...
},{"d207c1db4ee74c2c":"imGe5"}],"fXKUB":[function(require,module,exports,__globalThis) {
/**
...
},{}],"ZMwaT":[function(require,module,exports,__globalThis) {
const ECLevel = require("3e03da900b480fae");
...
},{"3e03da900b480fae":"kOfkT"}],"5QhX5":[function(require,module,exports,__globalThis) {
const Polynomial = require("ff60b60edd66ba5d");
...
},{"ff60b60edd66ba5d":"eQqQq"}],"eQqQq":[function(require,module,exports,__globalThis) {
const GF = require("e68f3d970da3baff");
/**
...
},{"e68f3d970da3baff":"fEQDJ"}],"fEQDJ":[function(require,module,exports,__globalThis) {
...
},{}],"9U3d4":[function(require,module,exports,__globalThis) {
const Utils = require("e9049a31aabc2a8e");
const ECCode = require("cb82c34f0f74fb73");
const ECLevel = require("8fa212e63b74234f");
const Mode = require("4a7e95c54afce545");
const VersionCheck = require("2b106b730472439b");
...
},{"e9049a31aabc2a8e":"imGe5","cb82c34f0f74fb73":"ZMwaT","8fa212e63b74234f":"kOfkT","4a7e95c54afce545":"i92T9","2b106b730472439b":"hIPY5"}],"i92T9":[function(require,module,exports,__globalThis) {
const VersionCheck = require("1ca20f1d27feed1e");
const Regex = require("1d92593a0bdf0426");
/**
...
},{"1ca20f1d27feed1e":"hIPY5","1d92593a0bdf0426":"k6OL4"}],"hIPY5":[function(require,module,exports,__globalThis) {
/**
...
},{}],"k6OL4":[function(require,module,exports,__globalThis) {
const numeric = '[0-9]+';
...
},{}],"26gFF":[function(require,module,exports,__globalThis) {
const Utils = require("277afc9299f6b8f9");
const G15 = 1335;
...
},{"277afc9299f6b8f9":"imGe5"}],"2lLSs":[function(require,module,exports,__globalThis) {
const Mode = require("7f1704cf5791c30e");
const NumericData = require("ac2bfddc8fe784b8");
const AlphanumericData = require("acec1327c20eb845");
const ByteData = require("b0c5372b48f0cd47");
const KanjiData = require("aa8708107eb16004");
const Regex = require("c8596df3fc154e8");
const Utils = require("284991bb6f349e64");
const dijkstra = require("1a4c341ac35fcc35");
/**
...
},{"7f1704cf5791c30e":"i92T9","ac2bfddc8fe784b8":"eDcdk","acec1327c20eb845":"ejG4N","b0c5372b48f0cd47":"97D0i","aa8708107eb16004":"83xPu","c8596df3fc154e8":"k6OL4","284991bb6f349e64":"imGe5","1a4c341ac35fcc35":"ljiLx"}],"eDcdk":[function(require,module,exports,__globalThis) {
const Mode = require("d700c7fa64da758b");
...
},{"d700c7fa64da758b":"i92T9"}],"ejG4N":[function(require,module,exports,__globalThis) {
const Mode = require("7b58728fb7e64d48");
/**
...
},{"7b58728fb7e64d48":"i92T9"}],"97D0i":[function(require,module,exports,__globalThis) {
const Mode = require("472520e234d012a");
...
},{"472520e234d012a":"i92T9"}],"83xPu":[function(require,module,exports,__globalThis) {
const Mode = require("2cb6a28103a29cdf");
const Utils = require("740d68cad094cf63");
...
},{"2cb6a28103a29cdf":"i92T9","740d68cad094cf63":"imGe5"}],"ljiLx":[function(require,module,exports,__globalThis) {
'use strict';
/******************************************************************************
 * Created 2008-08-19.
 *
...
},{}],"dFies":[function(require,module,exports,__globalThis) {
const Utils = require("e0204d89297f0b25");
...
},{"e0204d89297f0b25":"7fWma"}],"7fWma":[function(require,module,exports,__globalThis) {
...
},{}],"909vL":[function(require,module,exports,__globalThis) {
const Utils = require("e59faf2a3cde3ee3");
...
},{"e59faf2a3cde3ee3":"7fWma"}]},["cScS0","2R06K"], "2R06K", "parcelRequire94c2", {})

//# sourceMappingURL=validacao.0f77c784.js.map
